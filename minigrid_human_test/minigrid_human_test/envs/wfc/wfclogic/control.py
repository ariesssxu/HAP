...
from minigrid_human_test.envs.wfc.wfclogic.adjacency import adjacency_extraction
from minigrid_human_test.envs.wfc.wfclogic.patterns import (
    make_pattern_catalog_with_rotations,
    pattern_grid_to_tiles,
)
from minigrid_human_test.envs.wfc.wfclogic.solver import (
    Contradiction,
    StopEarly,
    TimedOut,
